...
<div class="hikashop_ginger_end" id="hikashop_ginger_end">
	<span class="hikashop_banktransfer_end_message" id="hikashop_banktransfer_end_message">
		<?php echo JText::_('ORDER_IS_COMPLETE').'<br/>'.
            ...
            JText::_('PLG_HIKASHOPPAYMENT_EMSPAYBANKTRANSFER_PAYMENT_REFERENCE')." ".$this->payment_reference.'<br/>'.
            JText::_('PLG_HIKASHOPPAYMENT_EMSPAYBANKTRANSFER_BANK_INFORMATION'). '<br/><br/>'.
            JText::_('PLG_HIKASHOPPAYMENT_EMSPAYBANKTRANSFER_BANK_NOTICE').'<br/>'.

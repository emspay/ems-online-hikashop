...
class plgHikashoppaymentIngpspHomePay extends IngpspPlugin
{
    ...
    {
        $element->payment_name = JText::_('PLG_HIKASHOPPAYMENT_INGSPSPHOMEPAY_NAME');
        $element->payment_description = JText::_('PLG_HIKASHOPPAYMENT_INGSPSPHOMEPAY_DESCRIPTION');
    ...
    protected function createIngpspOrder()
    {
        ...
        return $ginger->createHomePayOrder(

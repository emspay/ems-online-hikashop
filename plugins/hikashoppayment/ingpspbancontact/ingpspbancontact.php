...
class plgHikashoppaymentIngpspBancontact extends IngpspPlugin
{
    var $name = 'ingpspbancontact';
    ...
    {
        $element->payment_name = JText::_('PLG_HIKASHOPPAYMENT_INGPSPBANCONTACT_NAME');
        $element->payment_description = JText::_('PLG_HIKASHOPPAYMENT_INGPSPBANCONTACT_DESCRIPTION');

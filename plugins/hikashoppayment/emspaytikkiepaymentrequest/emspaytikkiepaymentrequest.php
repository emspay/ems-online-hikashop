...
class plgHikashoppaymentEmspayTikkiepaymentrequest extends EmspayPlugin
{
    var $name = 'emspaytikkiepaymentrequest';
    ...
    {
        $element->payment_name = JText::_('PLG_HIKASHOPPAYMENT_EMSPAYTIKKIEPAYMENTREQUEST_NAME');
        $element->payment_description =  JText::_('PLG_HIKASHOPPAYMENT_EMSPAYTIKKIEPAYMENTREQUEST_DESCRIPTION');

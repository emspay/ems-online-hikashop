...
class plgHikashoppaymentEmspayAmex extends EmspayPlugin
{
    var $name = 'emspayamex';
    ...
    {
        $element->payment_name = JText::_('PLG_HIKASHOPPAYMENT_EMSPAYAMEX_NAME');
        $element->payment_description =  JText::_('PLG_HIKASHOPPAYMENT_EMSPAYAMEX_DESCRIPTION');

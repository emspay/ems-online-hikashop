...
class plgHikashoppaymentEmspayWechat extends EmspayPlugin
{
    var $name = 'emspaywechat';
    ...
    {
        $element->payment_name = JText::_('PLG_HIKASHOPPAYMENT_EMSPAYWECHAT_NAME');
        $element->payment_description =  JText::_('PLG_HIKASHOPPAYMENT_EMSPAYWECHAT_DESCRIPTION');

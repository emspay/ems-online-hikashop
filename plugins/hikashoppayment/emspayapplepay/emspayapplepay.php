...
class plgHikashoppaymentEmspayApplepay extends EmspayPlugin
{
    var $name = 'emspayapplepay';
    ...
    {
        $element->payment_name = JText::_('PLG_HIKASHOPPAYMENT_EMSPAYAPPLEPAY_NAME');
        $element->payment_description =  JText::_('PLG_HIKASHOPPAYMENT_EMSPAYAPPLEPAY_DESCRIPTION');

...
<div class="hikashop_ginger_end" id="hikashop_ginger_end">
	<span class="hikashop_afterpay_end_message" id="hikashop_afterpay_end_message">
      <a href="<?php echo JUri::base(); ?>" class="btn button"><?php echo JText :: _('CONTINUE_SHOPPING');?></a>
	</span>
</div>
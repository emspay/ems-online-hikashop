...
class IngpspHelper
{
    ...
    public static function getCustomerInfo($user, $order)
    {
        return \GingerPayments\Payment\Common\ArrayFunctions::withoutNullValues([
            ...
            'birthdate' => JFactory::getSession()->get('ingpsp_dob'),
            'gender' => JFactory::getSession()->get('ingpsp_gender'),
        ]);
    }
    ...
    {
        JFactory::getSession()->clear('ingpsp_dob');
        JFactory::getSession()->clear('ingpsp_gender');
    }
